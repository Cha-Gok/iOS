...
private extension VoiceNoteSummaryViewController {
    ...
    var regenerationChipState: RegenerationChip.State? {
        ...
        case .pending, .summarizing, .transcribed, .transcribing, .transcriptionFailed, .grammarChecked, .grammarChecking, .grammarCheckFailed: return nil
    ...
    var isShowingSkeleton: Bool {
        switch viewModel.voiceNote.analysisState {
        case .pending, .regenerating, .summarizing, .transcribed, .transcribing, .grammarChecking, .grammarChecked:
            return true
